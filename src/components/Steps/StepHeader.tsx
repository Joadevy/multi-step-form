...
export const StepHeader: FC<props> = ({ steps, active }) => {
  return (
    <header className="h-48 w-full absolute lg:w-[275px] 2xl:w-[400px] lg:relative lg:h-auto top-0 -z-10 bg-mobileHero lg:bg-desktopHero flex bg-cover lg:bg-contain bg-no-repeat">
